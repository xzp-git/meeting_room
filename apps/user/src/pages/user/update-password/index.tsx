import { getCaptcha, updatePassword } from '@/services';
...
const updatePasswordRequest = async (userInfo: any) => {
...
const UpdatePasswordPage: FC = () => {
  ...
  const { run: runUpdatePassword } = useRequest(updatePasswordRequest, {
    manual: true,
    onSuccess() {
      navigate('/user/login');
    },
